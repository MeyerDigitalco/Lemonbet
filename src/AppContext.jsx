...
const AppContextProvider = (props) => {
  let apiBaseUrl = import.meta.env.VITE_APP_API_URL;//import.meta.env.VITE_API_URL;
  let serviceUrl = import.meta.env.VITE_APP_SERVICE_URL;
  let cdnUrl = import.meta.env.VITE_APP_CDN_URL;
  let pageTitle = import.meta.env.VITE_APP_PAGE_TITLE;
